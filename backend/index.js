...
// deloy vercel
mongoose
  .connect("mongodb+srv://abhishekkumar54635460:aauLai6EdKSJ2mZN@cluster0.3bz3qtw.mongodb.net/", {
...
// app.listen(port, '122.180.192.148' , () => {
...
app.post("/friend-request", async (req, res) => {
  ...
  console.log("Request sent to:", selectedUserId, "from:", currentUserId);
  try {
